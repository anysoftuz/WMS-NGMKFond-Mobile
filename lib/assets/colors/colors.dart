...
const _red = Color(0xffEA5455);
const _grey = Color(0xff698096);
...
const _whiteGrey = Color(0xFFF8F9FC);
...
const secondary500 = Color(0xFFA8AAAE);
const backgroundText = Color(0xFF4F5662);
const bg00 = Color(0xFFE2E6F3);
