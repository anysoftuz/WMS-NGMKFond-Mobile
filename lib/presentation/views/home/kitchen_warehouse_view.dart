...
class KitchenWarehouseView extends StatefulWidget {
  const KitchenWarehouseView({super.key});

  @override
  State<KitchenWarehouseView> createState() => _KitchenWarehouseViewState();
}

class _KitchenWarehouseViewState extends State<KitchenWarehouseView> {
  @override
